"""
Django settings for twizzle project.
...
SECRET_KEY = str(os.environ.get('TWIZZLE_SECRET_KEY'))

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['twizzly.herokuapp.com']
...
WSGI_APPLICATION = 'twizzle.wsgi.application'
